...
import { GRADEBOOK_DATA } from "../../../mocks/gradebook"; // Reusing student data
import {
    Dialog,
    DialogContent,
    DialogDescription,
        ...
        <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="space-y-4">
                <div className="flex items-center justify-between border-b border-indigo-200 pb-4">
                    <div className="flex items-center gap-4">
                        ...
                        <span className="bg-indigo-100 text-indigo-700 text-xs font-bold px-2 py-1 rounded-full">
                            {GRADEBOOK_DATA.students.length} students
                        </span>
                    </div>
                    <Dialog>
                        <DialogTrigger asChild>
                ...
                <div className="space-y-1">
                    {GRADEBOOK_DATA.students.map((student) => (
                        <div key={student.id} className="flex items-center justify-between py-3 px-2 hover:bg-gray-50 rounded-lg transition-colors border-b border-gray-50 last:border-0 group">
                            <div className="flex items-center gap-4">
